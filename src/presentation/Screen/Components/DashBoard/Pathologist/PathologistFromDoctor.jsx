...
//                   <Card.Content>
//                     <Text style={styles.title}>You did't got any prescription</Text>
//                   </Card.Content>
//                 </Card>
//               )}
//             </>
...
//   const { isLoading, getDoctorAllData, emailAddress, getPathologistDataFromDoctor, prescriptionFromDoctor, doctorData, isUserCardShowTo, setIsUserCardShowTo,isUserCardShowFrom, setIsUserCardShowFrom, setIsDbVisiable, setAnotherUser, address } = useContext(HealthContext);
...
//         const responsedData = await getPathologistDataFromDoctor(doctor, address);
