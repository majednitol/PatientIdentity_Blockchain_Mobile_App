...
//         getDoctorAllData,
//         doctorData,
//         reducerValue, pathologistDoctorList, doctorPathoList, setIsDbVisiable, getDoctorAllOtherData, address } = useContext(HealthContext);
//     const [DoctorPersonalPathoList, setDoctorPersonalPathoList] = useState([]);
//     const [refreshing, setRefreshing] = useState(false);
//     console.log("doctorPathoList", doctorPathoList)
//     const onRefresh = () => {
//         setRefreshing(true);
//         getDoctorAllData();
...
//                                     <Card.Content>
//                                         <Text style={styles.title}>You did't got any report</Text>
//                                     </Card.Content>
//                                 </Card>
//                             )}
//                         </>
...
//     const { isLoading, getPathologistAllData, emailAddress, getPathologistDataFromDoctor, getDoctorDataFromPathologist, doctorReportFromPatho, prescriptionFromDoctor, doctorData, address, isUserCardShowTo, setIsUserCardShowTo,isUserCardShowFrom, setIsUserCardShowFrom, setIsDbVisiable, setAnotherUser } = useContext(HealthContext);
...
//             const responedData = await fetchDoctorDataFromPathologist(pathologist, address);
//             setImageUrl(responedData)
...
//             setIsUserCardShowFrom(true)
            
//             console.log('isUserCardShowFromback',isUserCardShowFrom)
//         }
       

//         setIsDbVisiable(false)
//     }, [pathologist,imageUrl.length]);

//     return (
//         <View>
//             {isUserCardShowFrom === true ? (<TouchableOpacity onPress={() => {
